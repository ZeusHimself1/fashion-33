  ...
  return (
    <div>
      ...
      <div className="lg:max-w-md mx-auto">
        <h2 className="text-4xl font-extrabold mb-4">Discover Our Exclusive Features</h2>
        <p className="text-gray-500 text-sm">Laboris qui Lorem ad tempor ut reprehenderit. Nostrud anim nulla officia ea sit deserunt. Eu eu quis anim aute Laboris qui Lorem ad tempor ut reprehenderit. Eu eu quis anim aute.</p>
      </div>
      <div className="grid md:grid-cols-2 gap-12 max-md:max-w-lg mx-auto">
        <div className="text-left bg-blue-50 rounded-md p-6">
          ...
          <h3 className="text-xl font-semibold mt-6 mb-2">Customization</h3>
